...
#Did not include in final report, found it hard to differentiate between plots after size was reduced + dev type not very important to main analysis
survey_unnest %>%
...
survey_unnest %>%
  ...
  theme(legend.position = "bottom", plot.title = element_text(face = "bold", size = 8.5))
```
